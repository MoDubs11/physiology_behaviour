...
feeding_GLM<-glm(total$feeding_rate~total$inf_status*total$temp)
...
resp_GLM<-glm(total$resp_rate~total$inf_status*total$temp)
...
growth_GLM<-glm(total$rate~total$inf_status*total$temp)
...
eff_GLM<-glm(total$efficiency~total$inf_status*total$temp)
##generate eff AICs
AIC(eff_GAM)
AIC(eff_GLM)
...
ass_GLM<-glm(total$assimilation~total$inf_status*total$temp)
